...
(function(){
  ...
  function showMilestone(n){
    var meta = {
      5:  { h: 'Задание 5 из 21', sub: 'Пройдена <b>четверть варианта</b> — отличный темп!' },
      10: { h: 'Задание 10 из 21', sub: 'Уже <b>половина</b>. Продолжайте в том же духе.' },
      15: { h: 'Задание 15 из 21', sub: 'Три четверти позади. Финиш близко.' },
      20: { h: 'Задание 20 из 21', sub: 'Осталось <b>одно задание</b>. Финишная прямая!' }
    };
    var m = meta[n] || { h: 'Задание ' + n + ' из 21', sub: '' };
