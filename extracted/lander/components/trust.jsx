...
const Trust = () => {
  const reviews = [
    ...
    },
    {
      ...
      stars: 5,
      text: "Раньше тратили 12&nbsp;000&nbsp;₽ в&nbsp;месяц на&nbsp;репетитора по&nbsp;математике. Сейчас Даша занимается каждый день, а&nbsp;её&nbsp;средний балл на&nbsp;пробниках вырос на&nbsp;2&nbsp;балла.",
      tag: "Сэкономили 38 400 ₽",
    },
    {
      ...
      <div className="container">
        ...
        <div className="trust-stats">
          {[
            ...
            { v: "94%",  l: "родителей продлевают подписку", c: "amber" },
          ].map((s, i) => {
